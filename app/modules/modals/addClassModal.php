			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="input-group">
						<span class="input-group-addon"><strong>Class Code:</strong><span style="color:red;">*</span></span>
					...
					<div class="input-group">
						<span class="input-group-addon"><strong># of students:</strong></span>
					...
					<div class="input-group">
						<span class="input-group-addon"><strong>Subject:</strong><span style="color:red;">*</span></span>
					...
					<div class="input-group">
						<span class="input-group-addon"><strong>School Year:</strong></span>
							<select class="form-control" id="enabled">
								<option value="">Please Choose:</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
